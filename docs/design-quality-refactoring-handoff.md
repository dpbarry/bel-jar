...
| Doc | Why |
|-----|-----|
| [`CODEMAP.md`](CODEMAP.md) | **Atlas** — domains, duals, gods, satellites |
| [`AGENTS.md`](../AGENTS.md) | Commands + active product threads |
| [`prover-master-plan.md`](prover-master-plan.md) | Prover intelligence |
| [`incremental-semantics-execution-handoff.md`](incremental-semantics-execution-handoff.md) | Input / symbols keystone |
