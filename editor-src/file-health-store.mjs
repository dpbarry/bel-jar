// Explorer/tab dots are derived — never persisted to disk.
// Source of truth: development-check memberDiagnostics (whole suite) + live
// Beluga on the active file. No competing writable cache.
