(() => {
  ...
  function create8(deps) {
    ...
    function explorerFolderContextItems(folderPath) {
      const create11 = explorerCreateMenuItems(folderPath);
      const rename = [
      ...
      return create11.concat(rename).concat(destroy).concat(runBlock);
    }
    ...
    function backgroundRunItems() {
      const create11 = explorerCreateMenuItems("");
      if (signatureFileCount() < 1) return create11;
      return create11.concat([
...
${doc.documentElement.outerHTML}`;
  ...
  function create9(deps) {
    ...
    function exportCurrentManuscript() {
      const editor2 = getEditor();
      const persist = getPersist();
      const fileId = editor2?.getCurrentFileId?.() || persist?.getCurrentFileId?.() || Persist.getActiveFileId?.();
  ...
  function mount() {
    ...
    function __initAppPeels() {
      ...
      manuscriptExportApi = create9(Object.assign({}, peelHub, {
        projectFileText,
        showToast
      }));
