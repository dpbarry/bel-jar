...
// HarpoonEngine — the JS transport for the Harpoon (Architecture II).
//
...
(function (global) {
  ...
  function workerUrl(build) {
    var base = SCRIPT_SRC
      ? new URL('../beluga/beluga-worker.js', SCRIPT_SRC).href
  ...
  global.BelJarHarpoonEngine = global.HarpoonEngine;
