...
// kind === 'error' also pushes to BelJarNotifications (persistent inbox) unless
...
(function (global) {
  ...
  function pushNotification(message) {
    if (typeof global.BelJarNotifications !== 'undefined' && global.BelJarNotifications.push) {
      global.BelJarNotifications.push(message);
    }
  }
