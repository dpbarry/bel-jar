...
var panel = null;
  ...
  function enable() {
    global.PerfDebug = true;
    global.BelJarPerfDebug = global.PerfDebug
    var p = perf();
    if (p) p.enabled = true;
    ensurePanel();
    render();
  ...
  function disable() {
    ...
    global.PerfDebug = false;
    global.BelJarPerfDebug = global.PerfDebug
  }

  global.PerfHud = { enable: enable, disable: disable, refresh: render };
  global.BelJarPerfHud = global.PerfHud
