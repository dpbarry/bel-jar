// Project-scoped workspace UI snapshot (sidebars, floating windows). Global: BelJarWorkspaceState.
(function (global) {
  'use strict';
  ...
  function mergeFloatingSnapshots(priorFloating, activeFileId, openFileIds, liveFloating) {
    ...
    var kept = (priorFloating || []).filter(function (entry) {
      return entry && entry.fileId !== activeFileId && open.indexOf(entry.fileId) !== -1;
    });
