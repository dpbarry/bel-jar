const DEFAULT_MARGIN = 8;
  ...
  function computePosition(opts) {
    ...
    const vw =
      opts.viewportWidth ??
      (typeof globalThis.innerWidth === 'number' ? globalThis.innerWidth : 800);
    const vh =
      opts.viewportHeight ??
      (typeof globalThis.innerHeight === 'number' ? globalThis.innerHeight : 600);
  ...
  export const FloatingRectPlacement = {
    DEFAULT_MARGIN,
    DEFAULT_GAP,
