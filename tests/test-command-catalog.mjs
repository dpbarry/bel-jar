...
const EXPECTED_PALETTE_ORDER = [
  ...
  'edit.find', 'edit.search-project', 'edit.toggle-comment', 'edit.format',
  ...
  'nav.symbol', 'nav.goto-line', 'nav.definition', 'nav.references', 'nav.enclosing-decl', 'nav.binder', 'nav.inspector',
